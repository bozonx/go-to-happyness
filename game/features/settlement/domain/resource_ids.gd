...
const ERA_RESOURCES: Dictionary = {
	0: [BRANCHES, GRASS, WATER, FOOD, HIDES, GOODS, TARP],
	1: [BRANCHES, GRASS, WATER, FOOD, HIDES, GOODS, TARP, SOIL, WOOD],
	2: [BRANCHES, GRASS, WATER, FOOD, HIDES, GOODS, TARP, SOIL, WOOD, CLAY],
	3: [BRANCHES, GRASS, WATER, FOOD, HIDES, GOODS, TARP, SOIL, WOOD, CLAY, LOGS, BOARDS],
	4: [BRANCHES, GRASS, WATER, FOOD, HIDES, GOODS, TARP, SOIL, WOOD, CLAY, LOGS, BOARDS, STONE],
	5: [BRANCHES, GRASS, WATER, FOOD, HIDES, GOODS, TARP, SOIL, WOOD, CLAY, LOGS, BOARDS, STONE, BRICKS],
}
