...
const DEFINITIONS := {
	"campfire": {"name": "Главный костер ур. 1", "category": "tent", "costs": {"branches": 6}, "landmark": true, "demolishable": false},
	...
	"forager_tent_lvl2": {"name": "Forager-Hunter tent", "category": "tent", "costs": {"branches": 18, "grass": 10}},
	"forager_tent_lvl3": {"name": "Hunting lodge", "category": "tent", "costs": {"branches": 28, "grass": 16}},
	"materials_yard": {"name": "Двор стройматериалов ур. 1", "category": "tent", "costs": {"branches": 10, "grass": 6}},
	"materials_yard_lvl2": {"name": "Двор стройматериалов ур. 2", "category": "tent", "costs": {"branches": 16, "grass": 10}, "upgrade_only": true, "upgrades_from": "materials_yard"},
	"materials_yard_lvl3": {"name": "Двор стройматериалов ур. 3", "category": "tent", "costs": {"branches": 24, "grass": 16}, "upgrade_only": true, "upgrades_from": "materials_yard_lvl2"},
	...
	"dew_collector_lvl2": {"name": "Dew collector Level 2", "category": "tent", "costs": {"branches": 12, "grass": 8}},
	"dew_collector_lvl3": {"name": "Dew collector Level 3", "category": "tent", "costs": {"branches": 18, "grass": 12}},
	"pond": {"name": "Pond", "category": "tent", "costs": {"branches": 8, "grass": 6}},
	"warehouse": {"name": "Куча материалов (Склад ур. 1)", "category": "tent", "costs": {}},
	"warehouse_lvl2": {"name": "Склад ур. 2 (Палатка)", "category": "tent", "costs": {"branches": 15, "grass": 12}},
...
const RESEARCH_COSTS := {
	...
	"materials_yard": {"branches": 6, "grass": 4},
	"materials_yard_lvl2": {"branches": 10, "grass": 8},
	"materials_yard_lvl3": {"branches": 16, "grass": 12},
	"trade_tent": {"branches": 12, "grass": 8},
	"dew_collector_lvl2": {"branches": 8, "grass": 6},
	"dew_collector_lvl3": {"branches": 12, "grass": 10},
	"forager_tent_lvl2": {"branches": 8, "grass": 6},
	"forager_tent_lvl3": {"branches": 14, "grass": 12},
...
const RESEARCH_TECHS := {
	...
	"warehouse_lvl2": {
		"name": "Склад ур. 2 (Палатка)",
		"base_duration": 30.0,
		"required_skill": "construction",
		"target_building": "warehouse_lvl2",
		"prerequisites": [],
	},
	"materials_yard": {
		"name": "Двор стройматериалов ур. 1",
		"base_duration": 25.0,
		"required_skill": "construction",
		"target_building": "materials_yard",
		"prerequisites": ["campfire"],
	},
	"materials_yard_lvl2": {
		"name": "Двор стройматериалов ур. 2",
		"base_duration": 35.0,
		"required_skill": "construction",
		"target_building": "materials_yard_lvl2",
		"prerequisites": ["materials_yard"],
	},
	"materials_yard_lvl3": {
		"name": "Двор стройматериалов ур. 3",
		"base_duration": 50.0,
		"required_skill": "construction",
		"target_building": "materials_yard_lvl3",
		"prerequisites": ["materials_yard_lvl2"],
	},
	"trade_tent": {
		"name": "Палаточный рынок",
		"base_duration": 45.0,
		"required_skill": "construction",
		"target_building": "trade_tent",
		"prerequisites": ["campfire_lvl3"],
	},
	"dew_collector_lvl2": {
		"name": "Сборщик росы ур. 2",
		"base_duration": 30.0,
		"required_skill": "construction",
		"target_building": "dew_collector_lvl2",
		"prerequisites": [],
	},
	"dew_collector_lvl3": {
		"name": "Сборщик росы ур. 3",
		"base_duration": 45.0,
		"required_skill": "construction",
		"target_building": "dew_collector_lvl3",
		"prerequisites": ["dew_collector_lvl2"],
	},
	"forager_tent_lvl2": {
		"name": "Для охотников-собирателей ур. 2",
		"base_duration": 35.0,
		"required_skill": "construction",
	...
	"forager_tent_lvl3": {
		...
		"base_duration": 55.0,
		"required_skill": "construction",
		"target_building": "forager_tent_lvl3",
		"prerequisites": ["forager_tent_lvl2"],
	},
	"house": {
		"name": "Дом ур. 1",
		"base_duration": 40.0,
