...
func _uses_native_work_cycle() -> bool:
	return citizen.permanent_role in ["forestry", "farming", "construction", "gather_branches", "gather_food", "excavation", "cook", "teacher", "seller", "official", "craftsman", "factory_worker", "engineer"]
