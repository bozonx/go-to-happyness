...
func bind_events(target: Object) -> void:
	...
	_connect_event(events.build_menu_gui_input, target.get("selection_controller"), "on_build_menu_gui_input")
	_connect_event(events.manage_citizen_requested, target, "_take_control_of_selected_citizen")
	_connect_event(events.daily_order_submenu_requested, target.get("selection_controller"), "open_daily_order_submenu")
	_connect_event(events.personal_night_work_toggled, target.get("workplace_controller"), "toggle_selected_citizen_night_work")
	_connect_event(events.job_submenu_requested, target.get("selection_controller"), "open_job_submenu")
