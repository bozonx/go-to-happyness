...
static func era_is(p_era: int) -> EventCondition:
...
static func weather_is(p_weather: int) -> EventCondition:
	var c := EventCondition.new()
...
static func resource_at_least(res: String, amount: int) -> EventCondition:
	var c := EventCondition.new()
...
static func resource_at_most(res: String, amount: int) -> EventCondition:
	var c := EventCondition.new()
...
static func flag_set(flag_name: StringName) -> EventCondition:
	var c := EventCondition.new()
...
static func flag_not_set(flag_name: StringName) -> EventCondition:
	var c := EventCondition.new()
...
static func day_at_least(day: int) -> EventCondition:
	var c := EventCondition.new()
...
static func population_at_least(pop: int) -> EventCondition:
	var c := EventCondition.new()
