...
| **1** | `shallow` | 5.625° | $1 : 8$ | **8** | Длинные пологие дороги и серпантины для тяжёлого груза | Едва заметный уклон дёрна |
...
- **Якоря.** Ячейки под построенным зданием, дорогой или размещённым чертежом помечены
  ...
  **Пишет их пока никто:** в игре высоты не редактируются, а Placement Merge (§5.3) —
  фаза 5. Каскад свою половину инварианта соблюдает и покрыт тестами; вторая половина
  появится вместе с размещением чертежей.
