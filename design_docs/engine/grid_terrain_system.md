...
game/features/world/
  ...
  domain/water/
    ...
    starter_water.gd       # §9, пруды биома для сессии без карты
  application/
...
[Фаза 4b: Вода] — СДЕЛАНО, кроме рыболовства и сноса течением
   ...
   ├── Вода в сессии: пруды биома через StarterWater, берега через
   │   WaterAccessService; старая система пруд-как-декорация выпилена — СДЕЛАНО
