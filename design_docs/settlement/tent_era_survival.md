...
§7). Поэтому «холодно» перестаёт быть флагом прогноза и становится температурой из
снимка: правила ниже читают число, а название дня остаётся текстом для игрока.
