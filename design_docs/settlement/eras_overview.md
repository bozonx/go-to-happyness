...
[building_progression.md](../npc%20and%20village/building_progression.md). Детальный стартовый сценарий
...
к стратегическому управлению описаны в [work_positions.md](../work%20and%20resources/work_positions.md).
...
Экологическая и Индустриальная эры пока не являются дизайном: в `Era` их нет.
Наброски лежат в [ideas.md](../ideas.md) §1.
