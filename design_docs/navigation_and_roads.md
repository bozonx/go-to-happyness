...
В игре проектируется 7 типов дорожных покрытий. Каждый тип имеет свои требования к эпохе, ресурсам и накладывает ограничения на используемый транспорт.

| Тип покрытия | Скорость пешехода | Скорость транспорта | Допустимый транспорт | Стоимость (ресурсы и золото) | Эра разблокировки |
| :--- | :---: | :---: | :--- | :--- | :--- |
...
| **Глинобитная дорога** *(Clay Road)* | $110\%$ | $110\%$ | Пешеходы, Велосипеды, Велосипеды с тележкой | Глина, Почва | `Era.CLAY` |
| **Деревянная мостовая** *(Wooden Road)* | $120\%$ | $120\%$ | Пешеходы, Все велосипеды, Мопеды | Доски, Бревна | `Era.WOOD` |
| **Каменная дорога** *(Stone Road)* | $130\%$ | $140\%$ | Пешеходы, Велосипеды, Мопеды, Ранние паровые авто | Камень, Глина, Золото | `Era.STONE` |
| **Асфальтовая дорога** *(Asphalt Road)* | $140\%$ | $180\%$ | Все виды, включая легкий моторный транспорт | Гравий/Щебень, Битум (Нефть), Золото | `Era.BRICK` |
| **Асфальто-бетонная** *(Asphalt-Concrete)* | $150\%$ | $220\%$ | Все виды, включая тяжелые грузовики | Бетон, Сталь (арматура), Золото | `Era.INDUSTRIAL` |
...
- **Глинобитная дорога**: Позволяет использовать грузовые велосипеды (велосипеды с тележкой). В дождь не размывается так сильно, как грунтовая.
- **Деревянная мостовая**: Открывает возможность комфортной езды для мопедов.
- **Каменная дорога**: Позволяет двигаться всем видам легкого транспорта, включая первые паровые автомобили.
...
- `Era.TENT` (Палаточный лагерь): Максимальный авто-уровень — **Тропинка**.
- `Era.EARTH` (Земляная эра): Максимальный авто-уровень — **Грунтовая дорога**.
- `Era.CLAY` (Глиняная эра): Максимальный авто-уровень — **Глинобитная дорога**.
- `Era.WOOD` (Деревянная эра): Максимальный авто-уровень — **Деревянная мостовая**.
- `Era.STONE` (Каменная эра): Максимальный авто-уровень — **Каменная дорога**.
- `Era.BRICK` (Кирпичная эра): Допускается автоматический апгрейд до **Асфальтовой дороги** (при условии изученных технологий).
...
const RESEARCH_TECHS := {
	...
	"dirt_road_construction": {
		...
		"prerequisites": [],
		"cost": {"soil": 10, "branches": 5}
	},
	"clay_road_stabilization": {
		"name": "Глинобитные дороги",
		"base_duration": 45.0,
		"required_skill": "construction",
		"target_building": "clay_road",
		"prerequisites": ["dirt_road_construction"],
		"cost": {"clay": 12, "soil": 10}
	},
	"wooden_road_planking": {
		"name": "Деревянные мостовые",
		"base_duration": 60.0,
		"required_skill": "construction",
		"target_building": "wooden_road",
		"prerequisites": ["clay_road_stabilization"],
		"cost": {"boards": 15, "logs": 5}
	},
	"stone_road_paving": {
		"name": "Мощение камнем",
		"base_duration": 80.0,
		...
		"prerequisites": ["wooden_road_planking"],
		"cost": {"stone": 20, "clay": 10, "money": 30}
	},
	"asphalt_laying": {
...
enum RoadType { NONE, PATH, DIRT, CLAY, WOODEN, STONE, ASPHALT, ASPHALT_CONCRETE }
...
func get_cell_weight(cell: Vector2i) -> float:
	...
	match road_type:
		...
		RoadType.DIRT:
			return 1.0 # Базовая стоимость
		RoadType.CLAY:
			return 0.9 # Легкое ускорение
		RoadType.WOODEN:
			return 0.85 # Среднее ускорение
		RoadType.STONE:
