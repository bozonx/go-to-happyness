...
| Эпоха / Код | Тип управления | Базовые материалы | Главный транспорт | Дорожная сеть |
| :--- | :--- | :--- | :--- | :--- |
| **1. Палаточная** (`TENT`) | Выживание племени | Ветки, Трава | Отсутствует | Тропинка (*Dirt Path*) |
| **2. Земляная** (`EARTH`) | Небольшая община | Почва, Ветки, Кожа | Велосипеды | Грунтовая дорога (*Dirt Road*) |
| **3. Глиняная** (`CLAY`) | Поселение ремесленников | Глина, Простой металл | Велосипеды с тележкой | Глинобитная дорога (*Clay Road*) |
| **4. Деревянная** (`WOOD`) | Деревянный городок | Доски, Бревна | Мопеды | Деревянная мостовая (*Wooden Road*) |
| **5. Каменная** (`STONE`) | Каменный город | Камень, Черепица | Мопеды с коляской | Каменная дорога (*Stone Road*) |
| **6. Кирпичная** (`BRICK`) | Ранний индустриальный узел | Кирпич, Стекло | Легковые / Грузовые авто | Асфальтовая дорога (*Asphalt Road*) |
| **7. Экологическая** (`ECO`) | Эко-устойчивое поселение | Эко-материалы, Композиты | Электровелосипеды / Электрокары | Выделенные эко-полосы / Эко-плитка |
| **8. Индустриальная** (`INDUSTRIAL`)* | Глобальный макро-менеджмент | Чугун, Железобетон, Сплавы | Поезда, Тяжелые грузовики | Асфальто-бетонная / Железная дорога |
...
*   **Торговля**: Полноценной торговли и экспорта еще нет. Сразу доступна только аварийная закупка через въездной камень: сухпайки и строительные перчатки. Расширенная торговля появляется после постройки палаточного рынка, открываемого Костром 3-го уровня.
...
### 5.2. Палаточная эра: рост лагеря внутри эпохи
Не все здания палаточной эры должны иметь одинаковые три уровня. Часть построек прокачивается внутри эпохи, часть является одноуровневым переходным инструментом, а часть мотивирует переходить в следующую эру.

| Здание | Уровни в палаточной эре | Отличие прогрессии |
| :--- | :---: | :--- |
| **Главный костер** | 3 | Центральный landmark и технологический шлюз. Ур. 1 открывает исследования, ур. 2 включает профессию чиновника и технологии второго тира, ур. 3 открывает третий тир и переход к Earth. |
| **Жилая палатка** | 3 | Постепенно растет вместимость: 1, 2 и 3 жителя. |
| **Большая палатка** | 1 | Альтернатива через исследование: сразу вмещает 4 жителей, но не развивает интерьер по уровням. |
| **Сборщик росы** | 3 | Увеличивает скорость и запас воды: медленный базовый тент, улучшенный купол, затем крупный резервуар 3x3 с фильтрацией. |
| **Палатка охотников-собирателей** | 3 | Ур. 1 добывает только еду; ур. 2 добавляет второго работника, простую охоту и шанс кожи; ур. 3 повышает слаженность группы и стабильность добычи кожи. |
| **Ремесленная палатка** | 3 | Увеличивает скорость производства, число мест и доступ к более качественным изделиям. |
| **Костер для готовки** | 1 | Единственная кухня палаточной эры. Следующий шаг пищевой цепочки — уже `dugout_kitchen` в Earth. |
| **Склады** | 2 | Открытая куча дает логистику, но портит органику; палаточный склад защищает ресурсы. |
| **Двор материалов** | 1 | Автоматизирует базовый сбор веток и травы, заменяя ранние ручные приказы. |
| **Палаточный рынок** | 1 | Открывается Костром ур. 3, расширяет торговлю через въездной камень и позволяет купить инструменты для перехода в Earth. |
| **Лобное место** | 1 | Социальное место для отдыха и общения, без обязательной многоуровневой прокачки внутри эпохи. |

Правило вовлечения: апгрейд должен либо снижать рутину, либо визуально менять поселение, либо открывать новый ресурс/роль. Улучшенный сборщик росы становится крупнее, открытая куча превращается в защищенный навес, а костер из стартового очага вырастает в управленческий центр лагеря.
