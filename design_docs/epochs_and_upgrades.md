...
*   **Ограничения**:
    ...
    *   Управление трудом: до изучения и назначения чиновника игрок выдает только дневные приказы. Помощник, ручной сбор и ручное строительство забываются утром; постоянные профессии появляются после оформления работы.
...
*   **Транспорт и инфраструктура**:
    ...
    *   *Логистика*: **Почта** открывает постоянную профессию курьера. До почты доставку стройматериалов, локальную переноску, встречу новых жителей, закупки и заработки через входную табличку закрывает дневной приказ **«Помощник»**.
*   **Торговля**:
...
*   **Транспорт и инфраструктура**:
    ...
    *   *Строительство*: **Гильдия строителей** открывает постоянную профессию строителя и автоматический выбор снабженных строек из очереди. До нее строительство остается дневным приказом выбранным жителям.
*   **Торговля**:
