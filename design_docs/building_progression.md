...
| **Костер для готовки** | 3 | Ур. 1 -- малый костер с котлом. Ур. 2 увеличивает запас еды. Ур. 3 добавляет навес и завершает палаточную кухонную ветку перед `dugout_kitchen`. |
