...
- [food_water_progression.md](../work%20and%20resources/food_water_progression.md) — прогрессия еды и воды от рюкзака до столовых;
- [storage_warehouses.md](../npc%20and%20village/storage_warehouses.md) — склады, рюкзак, кучи;
- [building_progression.md](../npc%20and%20village/building_progression.md) — цепочки зданий;
- [work_positions.md](../work%20and%20resources/work_positions.md) — рабочие позиции, FPP-роли, чиновник;
- [village_territory.md](../npc%20and%20village/village_territory.md) — область деревни, радиусы застройки, границы.
...
*   Через 2 часа юнит возвращается (спавнится у таблички) и относит товары на склад. Если доступного склада нет или все склады заполнены, он сбрасывает их на землю рядом с табличкой, образуя «открытую кучу ресурсов», которую необходимо разобрать. Подробнее о кучах и переполнении — в [storage_warehouses.md](../npc%20and%20village/storage_warehouses.md).
...
Палаточная эра использует несколько уровней хранения, чтобы игрок почувствовал переход от временного лагеря к организованному быту. Детальные правила складов, рюкзака и куч — в [storage_warehouses.md](../npc%20and%20village/storage_warehouses.md).
...
[labour_time_and_overtime.md](../work%20and%20resources/labour_time_and_overtime.md). Постоянного
