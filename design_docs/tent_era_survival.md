...
*   **Брезентовый тент:** 1 штука. С ним связана первая дилемма: сделать из него сборщик росы или укрыть им склад-кучу от дождя.
...
*   **Разблокировка Костра 1-го уровня (Campfire Lvl 1):**
    *   Как только склад построен, поселенцы могут собирать ресурсы впрок. Игрок размещает чертёж Костра 1-го уровня и строит его самостоятельно — стартовой огневой точки у входной таблички нет.
    *   **Механика апгрейда костра:** В лагере может быть только **один** Главный костер. Он является ключевым ориентиром (landmark) — его **нельзя сносить или свободно строить в произвольных местах**. Вместо этого игрок выбирает существующий костер и нажимает кнопку **«Улучшить» (Upgrade)**, что запускает процесс улучшения с расходом ресурсов со склада. Костер, как и любой другой источник огня, может погаснуть во время дождя или от нехватки дров, после чего его нужно заново разжечь.
...
Палаточная эра использует несколько уровней хранения, чтобы игрок почувствовал переход от временного лагеря к организованному быту.
...
| **Склад с соломенным навесом** | Соломенный навес над кучей | 48 | Требует изучения соломенных построек и ресурсов; товары почти не портятся, но само здание изнашивается и требует ремонта. |
| **Склад с брезентовым навесом** | Брезентовый навес с несколькими входами | 72+ | Требует брезента и торговли; защищает содержимое, не ломается. |
| **Брезентовая накидка над кучей** | Стартовый брезентовый тент, натянутый над складом | 24 | Защищает от дождя, но не увеличивает вместимость; расходует стартовый тент. |
