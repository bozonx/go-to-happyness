...
*   **Логистика пищи:** работник возвращает добычу к своему дому и ожидает курьера; только курьер отвозит ресурс на склад.
*   **Поденная работа:** через меню входной таблички можно отправить выбранного NPC в соседний населенный пункт. Он отсутствует одни сутки и по возвращении приносит 8 монет.
