...
*   **Постройка склада:**
    ...
    4.  Ранние поручения являются дневными приказами. Если житель сегодня помогает стройке, собирает траву или работает «Помощником», утром это поручение забывается и должно быть выдано заново.
