...
| [world_environment.md](engine/world_environment.md) | Окружение мира одной системой: календарь и время, сезон и климатический профиль, температура, погода и две оси облачности, ветер, осадки, небо и светила, туман, снимок и управление из скриптов, лаборатория. |
